...
//            dd($parts);
            ...
            define("__CA_DB_TYPE__", $parts['scheme']);
        }
	}
}
//dd(__CA_DB_HOST__);
...
if (!defined("__CA_APP_DISPLAY_NAME__")) {
	define("__CA_APP_DISPLAY_NAME__", "Demo from Seth");
}
...
if (!defined("__CA_ADMIN_EMAIL__")) {
	define("__CA_ADMIN_EMAIL__", 'tacman@gmail.com');
}
